"""
Template spider for an airline-direct source (Akasa Air used as the example).
"""
...
class AkasaSpider(scrapy.Spider):
    name = "akasa"
    allowed_domains = ["flyakasa.com"]
