...
# Prefer Supabase/Postgres when DATABASE_URL is set (persistent across
# Vercel invocations). Fall back to ephemeral SQLite at /tmp on Vercel
# only when no Postgres URL is configured.
