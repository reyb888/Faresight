...
<section id="index" class="grid lg:grid-cols-12 gap-6 pb-8 reveal">
  ...
  <div class="lg:col-span-4 bg-zinc-900 text-white rounded-2xl p-6 relative overflow-hidden flex flex-col">
    ...
    <div class="relative">
      ...
      <div class="mt-4 bg-white/10 rounded-xl p-3 mono text-xs leading-relaxed border border-white/10">APIX(t) = sum [ w x ( P(t) / P(0) ) ] x 100</div>
...
<section id="heatmap" class="reveal py-8">
  ...
  <p class="text-[13px] text-zinc-500 mt-1">Route x advance window - latest snapshot - median total fare. Darker means higher.</p>
