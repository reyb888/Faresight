...
class AdaptivePlaywrightCrawler extends playwright_crawler_1.PlaywrightCrawler {
    ...
    get userRequestHandler() {
        return this.adaptiveRequestHandler;
    }
    constructor(options = {}, config = core_1.Configuration.getGlobalConfig()) {
        const { requestHandler, renderingTypeDetectionRatio = 0.1, renderingTypePredictor, resultChecker, shouldPropagateError, resultComparator, statisticsOptions, preventDirectStorageAccess = true, ...rest } = options;
        super(rest, config);
        ...
        Object.defineProperty(this, "shouldPropagateError", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async _runRequestHandler(crawlingContext) {
        ...
        try {
            ...
            if (renderingTypePrediction.renderingType === 'static' && !shouldDetectRenderingType) {
                ...
                if (!plainHTTPRun.ok) {
                    const error = plainHTTPRun.error;
...
function createAdaptivePlaywrightRouter(routesOrSchemas) {
    return core_1.Router.create(routesOrSchemas);
}
