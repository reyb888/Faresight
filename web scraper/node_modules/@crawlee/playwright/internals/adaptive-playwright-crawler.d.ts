import type { BrowserHook, LoadedContext, RequestHandler, RouterHandler, RouteSchemas, RoutesFromSchemas } from '@crawlee/browser';
...
// @ts-ignore optional peer dependency or compatibility with es2022
     ...
     */
    protected get userRequestHandler(): RequestHandler<PlaywrightCrawlingContext>;
