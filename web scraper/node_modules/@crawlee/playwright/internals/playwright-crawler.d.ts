...
import type { CommonPage, PlaywrightController, PlaywrightPlugin } from '@crawlee/browser-pool';
...
// @ts-ignore optional peer dependency or compatibility with es2022
    ...
    protected _enhanceCrawlingContextWithPageInfo(crawlingContext: PlaywrightCrawlingContext, page: CommonPage, createNewSession?: boolean): void;
