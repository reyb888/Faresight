...
class SessionPool extends node_events_1.EventEmitter {
    ...
    constructor(options = {}, config = configuration_1.Configuration.getGlobalConfig()) {
        ...
        const { maxPoolSize = consts_1.MAX_POOL_SIZE, persistStateKeyValueStoreId, persistStateKey = consts_1.PERSIST_STATE_KEY, createSessionFunction, sessionOptions = {}, blockedStatusCodes = consts_1.BLOCKED_STATUS_CODES, log = log_1.log, persistenceOptions = {
            enable: true,
        }, } = options;
        this.config = config;
