...
class BasicCrawler {
    ...
    constructor(options = {}, config = core_1.Configuration.getGlobalConfig()) {
        ...
        Object.defineProperty(this, "unexpectedStop", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "maxCrawlDepth", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "maxRequestsPerCrawl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        const { requestList, requestQueue, requestManager, maxRequestRetries = 3, sameDomainDelaySecs = 0, maxSessionRotations = 10, maxRequestsPerCrawl, maxCrawlDepth, autoscaledPoolOptions = {}, keepAlive, sessionPoolOptions = {}, useSessionPool = true, 
        ...
        if (!this.requestManager) {
            this.requestManager =
                this.requestList === undefined
                    ? this.requestQueue
                    : new core_1.RequestManagerTandem(this.requestList, this.requestQueue);
        }
    ...
    async initializeRequestManager() {
        ...
        if (this.requestList && this.requestQueue) {
            ...
            this.requestManager = new core_1.RequestManagerTandem(this.requestList, this.requestQueue);
        }
            ...
            this.requestManager = new core_1.RequestListAdapter(this.requestList);
        }
    ...
    async _runTaskFunction() {
        ...
        const session = this.useSessionPool
            ? await this._timeoutAndRetry(this.sessionPool.getSession.bind(this.sessionPool), this.internalTimeoutMillis, `Fetching session timed out after ${this.internalTimeoutMillis / 1e3} seconds.`)
            : undefined;
        (0, timeout_1.tryCancel)();
    ...
    async *addCrawlDepthRequestGenerator(requests, newRequestDepth) {
        for await (const request of requests) {
            if (typeof request === 'string') {
                ...
                request.crawlDepth ?? (request.crawlDepth = newRequestDepth);
                yield request;
            }
        }
    }
    ...
    async _timeoutAndRetry(handler, timeout, error, maxRetries = 3, retried = 1) {
        try {
            return await (0, timeout_1.addTimeoutToPromise)(handler, timeout, error);
        }
        catch (e) {
...
Object.defineProperty(BasicCrawler, "optionsShape", {
    ...
    value: {
        ...
        maxCrawlDepth: ow_1.default.optional.number,
        ...
        respectRobotsTxtFile: ow_1.default.optional.any(ow_1.default.boolean, ow_1.default.object),
