...
export declare class DatasetClient<Data extends Dictionary = Dictionary> extends BaseClient implements storage.DatasetClient<Data> {
    ...
    listItems(options?: storage.DatasetClientListOptions): AsyncIterable<Data> & Promise<storage.PaginatedList<Data>>;
    listEntries(options?: storage.DatasetClientListOptions): AsyncIterable<[number, Data]> & Promise<storage.PaginatedList<[number, Data]>>;
    private listItemsPage;
