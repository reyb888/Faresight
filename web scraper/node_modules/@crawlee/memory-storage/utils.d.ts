 ...
 */
export declare function createLazyIterablePromise<TPromise, TElement>(promiseFactory: () => Promise<TPromise>, iteratorFactory: () => AsyncGenerator<TElement>): AsyncIterable<TElement> & Promise<TPromise>;
export {};
