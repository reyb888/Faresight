...
class LaunchContext {
    constructor(options) {
        ...
        Object.defineProperty(this, "proxyTier", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        const { id, browserPlugin, launchOptions, proxyUrl, useIncognitoPages, browserPerProxy, experimentalContainers, userDataDir = '', proxyTier, ignoreProxyCertificate, } = options;
        this.id = id;
