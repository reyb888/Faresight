    ...
    async _newPage(contextOptions) {
        ...
        if (this.launchContext.useIncognitoPages) {
            ...
            if (contextOptions?.proxy) {
                const [anonymizedProxyUrl, closeProxy] = await (0, anonymize_proxy_1.anonymizeProxySugar)(contextOptions.proxy.server, contextOptions.proxy.username, contextOptions.proxy.password, { ignoreProxyCertificate: this.launchContext.ignoreProxyCertificate });
