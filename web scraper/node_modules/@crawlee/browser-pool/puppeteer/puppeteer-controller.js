    ...
    async _newPage(contextOptions) {
        if (contextOptions !== undefined) {
            ...
            if (contextOptions.proxyServer) {
                const [anonymizedProxyUrl, closeProxy] = await (0, anonymize_proxy_1.anonymizeProxySugar)(contextOptions.proxyServer, contextOptions.proxyUsername, contextOptions.proxyPassword, { ignoreProxyCertificate: this.launchContext.ignoreProxyCertificate });
