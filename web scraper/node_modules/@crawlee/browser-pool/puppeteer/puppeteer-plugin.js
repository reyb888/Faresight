...
class PuppeteerPlugin extends browser_plugin_1.BrowserPlugin {
    async _launch(launchContext) {
        ...
        const { launchOptions, userDataDir, useIncognitoPages, experimentalContainers, proxyUrl, ignoreProxyCertificate, } = launchContext;
        ...
        let browser;
        {
            const [anonymizedProxyUrl, close] = await (0, anonymize_proxy_1.anonymizeProxySugar)(proxyUrl, undefined, undefined, {
                ...
                if (property === 'newPage') {
                    return async (...args) => {
                        ...
                        if (useIncognitoPages) {
                            const [anonymizedProxyUrl, close] = await (0, anonymize_proxy_1.anonymizeProxySugar)(proxyUrl, undefined, undefined, { ignoreProxyCertificate });
                            try {
